...
<!-- Mirrored from car-house.sohelrana.me/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2017 17:33:39 GMT -->
<head>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-content-box">
                    ...
                    <form method="post" class="login" action="http://car-house.sohelrana.me/index.html">
                        <div class="form-group">
                            <input type="email" class="input-text" name="email" id="email" placeholder="Email Address">
                        </div>

                        <input type="submit" name="submit" class="btn btn-send btn-block" value="Send me email">
                    </form>
                </div>
