<?php
    ...
    $result = $obj_userPost->all_userPost_info_for_admin();
    ...
    if(isset($_GET['delete'])){
        $user_post_id = $_GET['delete'];
        $message = $obj_userPost->delete_user_post_info($user_post_id);
    }
...
<head>
    ...
    <title>Admin | Manage User Post</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Manage User Post</li>
            </ol>
        </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <br>
                    <!--end -->
                    <h3 class="text-center text-success text-bold">All User Post Information</h3><br>
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $all_result){ ?>
                                <tr class="success">
                                    <td><?php echo $all_result['user_post_id'] ?></td>
                                    <td><?php echo $all_result['car_name'] ?></td>
                                    <td><?php echo $all_result['car_price'] ?></td>
                                    <td><?php echo $all_result['car_model'] ?></td>
                                    <td><?php echo $all_result['car_registration'] ?></td>
                                    <td><?php echo $all_result['cng_status'] ?></td>
                                    <td><?php echo $all_result['cng_com'] ?></td>
                                    <td><?php echo $all_result['car_cc'] ?></td>
                                    <td><?php echo $all_result['engine'] ?></td>
                                    <!--<td><img src="../../../mainSite/<?php /*$len = strlen($all_result['car_image']); $image = substr($all_result['car_image'],3,$len); echo $image;*/?>" alt="car-image" height="60" width="60"></td>-->
                                    <td><img src="../../../mainSite/assets/image/<?php echo $all_result['car_image']?>" alt="car-image" height="60" width="60"></td>
                                    <td>
                                        <?php
                                    ...
                                    <td>
                                        <a href="edit_user_post.php?id=<?php echo $all_result['user_post_id'] ?>" class="btn btn-success btn-sm" title="Edit">
                                            <span class="glyphicon glyphicon-edit"></span>
                                        </a>
                                        <a href="?delete=<?php echo $all_result['user_post_id'] ?>" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm('Are you sure to Delete this!');">
