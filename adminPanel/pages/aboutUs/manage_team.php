<?php
    ...
    /*view about us team member information from database*/
    $obj_about_us_team = new AboutUs();
    $result = $obj_about_us_team->all_about_us_member_info_for_admin();
    ...
    if(isset($_GET['delete'])){
        $about_us_member_id = $_GET['delete'];
        $message = $obj_about_us_team->delete_about_us_team_member_info($about_us_member_id);
    }
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <br>
                    <!--end -->
                    <h3 class="text-center text-success text-bold">All Team Member Information</h3><br>
                    <table class="table table-bordered table-hover">
                        ...
                        foreach ($result as $all_result){ ?>
                            <tr class="success">
                                <td><?php echo $all_result['team_member_id'] ?></td>
                                <td><?php echo $all_result['member_name']?></td>
                                <td><?php echo $all_result['member_designation']?></td>
                                <td><?php echo substr($all_result['member_sort_desc'],0,10)."..."; ?></td>
                                <td><?php echo substr($all_result['facebook_link'],0,10)."..."; ?></td>
                                <td><?php echo substr($all_result['twitter_link'],0,10)."..."; ?></td>
                                <td><?php echo substr($all_result['linkedin_link'],0,10)."..."; ?></td>
                                <td><?php echo substr($all_result['googleplus_link'],0,10)."..."; ?></td>

                                <td><img src="../../../<?php $len = strlen($all_result['member_image']); $image = substr($all_result['member_image'],9,$len); echo $image;?>" alt="post_image" height="60" width="60"></td>
                                ...
                                <td>
                                    <a href="edit_team.php?id=<?php echo $all_result['team_member_id'] ?>" class="btn btn-success btn-sm" title="Edit">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                    <a href="?delete=<?php echo $all_result['team_member_id'] ?>" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm('Are you sure to Delete this!');">
