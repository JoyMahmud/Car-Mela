                    ...
                    <div class="well">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="service_icon" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="service_desc" class="form-control" maxlength="100" rows="5" required></textarea>
                                </div>
                            </div>
