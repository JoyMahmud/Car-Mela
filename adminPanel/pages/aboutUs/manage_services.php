<?php
    ...
    /*view about us services information from database*/
    $obj_about_us_services = new AboutUs();
    $result = $obj_about_us_services->all_about_us_services_info_for_admin();
    ...
    if(isset($_GET['delete'])){
        ...
        $message = $obj_about_us_services->delete_about_us_services_info($services_id);
    }
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <br>
                    <!--end -->
                    <h3 class="text-center text-success text-bold">All Services</h3><br>
                    <table class="table table-bordered table-hover">
                        ...
                        foreach ($result as $all_result){ ?>
                            <tr class="success">
                                ...
                                <td><?php echo $all_result['service_icon'] ?></td>
                                <td><?php echo $all_result['service_title'] ?></td>
                                <td><?php echo substr($all_result['service_desc'],0,15)."..."; ?></td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <a href="edit_services.php?id=<?php echo $all_result['service_id'] ?>" class="btn btn-success btn-sm" title="Edit">
