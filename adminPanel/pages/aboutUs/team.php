<?php
    ...
    /* About us Team Member information insert in database*/
    if(isset($_POST['btn'])){
        $obj_team = new AboutUs();
        $message = $obj_team->save_team_info($_POST);
    }
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!--end -->
                    <div class="well">
                        <h3 class="text-center text-success">Add Car Bikroy Mela Team Members</h3><br>
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="member_sort_desc" class="form-control" maxlength="150" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <button type="submit" name="btn" class="btn btn-success btn-block">Save Team Member Info</button>
                                </div>
                            </div>
                        </form>
                    </div>
