<?php
    ...
    /*view about us Choose information from database*/
    $obj_about_us_choose = new AboutUs();
    $result = $obj_about_us_choose->all_choose_us_info_for_admin();
    ...
    if(isset($_GET['delete'])){
        $choose_id = $_GET['delete'];
        $message = $obj_about_us_choose->delete_about_us_choose_info($choose_id);
    }
...
<head>
    ...
    <title>Admin | Manage Choose Us</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="chooseUs.php">Choose Us</a></li>
                <li class="active">Manage Choose</li>
            </ol>
        </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <br>
                    <!--end -->
                    <h3 class="text-center text-success text-bold">All Choose Us Information</h3><br>
                    <table class="table table-bordered table-hover">
                        ...
                        foreach ($result as $all_result){ ?>
                            <tr class="success">
                                <td><?php echo $all_result['choose_us_id'] ?></td>
                                <td><?php echo substr($all_result['choose_details'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['reason_one'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['reason_two'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['reason_three'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['reason_four'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['reason_five'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['reason_six'],0,15)."..."; ?></td>
                                ...
                                <td>
                                    <a href="edit_choose_us.php?id=<?php echo $all_result['choose_us_id'] ?>" class="btn btn-success btn-sm" title="Edit">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                    <a href="?delete=<?php echo $all_result['choose_us_id'] ?>" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm('Are you sure to Delete this!');">
