<?php
    ...
    /*view about us rules information from database*/
    $obj_about_us_rules = new AboutUs();
    $result = $obj_about_us_rules->all_about_us_rules_info_for_admin();
    ...
    if(isset($_GET['delete'])){
        $rules_id = $_GET['delete'];
        $message = $obj_about_us_rules->delete_about_us_rules_info($rules_id);
    }
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Manage Rules Regulation</li>
            </ol>
        </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <br>
                    <!--end -->
                    <h3 class="text-center text-success text-bold">All Rules Regulation</h3><br>
                    <table class="table table-bordered table-hover">
                        ...
                        foreach ($result as $all_result){ ?>
                            <tr class="success">
                                <td><?php echo $all_result['rules_id'] ?></td>
                                <td><?php echo substr($all_result['rules_details'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['rules_one'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['rules_two'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['rules_three'],0,15)."..."; ?></td>
                                <td><?php echo substr($all_result['rules_four'],0,15)."..."; ?></td>
                                <td><?php echo $all_result['video'] ?></td>
                                ...
                                <td>
                                    <a href="edit_rules.php?id=<?php echo $all_result['rules_id'] ?>" class="btn btn-success btn-sm" title="Edit">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                    <a href="?delete=<?php echo $all_result['rules_id'] ?>" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm('Are you sure to Delete this!');">
