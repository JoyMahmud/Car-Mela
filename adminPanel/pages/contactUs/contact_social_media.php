<?php
    ...
    /* Contact us social media information insert in database*/
    if(isset($_POST['btn'])){
        $obj_social_media = new ContactUs();
        $message = $obj_social_media->save_social_media_info($_POST);
    }
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="contact_address.php"><i class="glyphicon glyphicon-plus"></i> Add Contact Address </a></li>
                        <li><a href="contact_social_media.php"><i class="glyphicon glyphicon-plus"></i> Add Socila Media </a></li>

                        <li><a href="manage_contact_address.php"><i class="glyphicon glyphicon-edit"></i> Manage Contact Address </a></li>
                        <li><a href="manage_contact_social_media.php"><i class="glyphicon glyphicon-edit"></i> Manage Social Media </a></li>
                    </ul>
                </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!--end -->
                    <div class="well">
                        <h3 class="text-center text-success">Add Car Bikroy Mela Social Media Address</h3><br>
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">

                            <div class="form-group">
                                <label for="facebook" class="col-sm-2 control-label">Facebook Address</label>
                                <div class="col-sm-8">
                                    <input type="text" name="facebook" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="twitter" class="col-sm-2 control-label">Twitter Address</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label for="linkedin" class="col-sm-2 control-label">Linkedin Address</label>
                                <div class="col-sm-8">
                                    <input type="text" name="linkedin" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="googleplus" class="col-sm-2 control-label">GooglePlus Address</label>
                                <div class="col-sm-8">
                                    <input type="text" name="googleplus" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <button type="submit" name="btn" class="btn btn-success btn-block">Save Social Media Address Info</button>
                                </div>
                            </div>
                        </form>
                    </div>
