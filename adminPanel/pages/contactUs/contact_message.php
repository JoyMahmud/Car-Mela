<?php
    ...
    $result = $obj_contact_us->all_user_message_info();
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">User Message</li>
            </ol>
        </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <br>
                    <!--end -->
                    <h3 class="text-center text-success text-bold">All User Message Information</h3><br>
                    <table class="table table-bordered table-hover">
                        <thead>
                        <tr class="info">
                            <th>User Message ID</th>
                            <th>User Name</th>
                            <th>User Email</th>
                            <th>User Phone</th>
                            <th>User Website</th>
                        ...
                        foreach ($result as $all_result){ ?>
                            <tr class="success">
                                <td><?php echo $all_result['contact_form_id'] ?></td>
                                <td><?php echo $all_result['full_name'] ?></td>
                                <td><?php echo $all_result['email']?></td>
                                <td><?php echo $all_result['phone_number'] ?></td>
                                <td><?php echo $all_result['your_website'] ?></td>
                                <td><?php echo substr($all_result['message'],0,30)."..."; ?></td>
