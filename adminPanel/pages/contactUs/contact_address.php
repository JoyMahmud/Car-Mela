<?php
    ...
    /* Contact us address information insert in database*/
    if(isset($_POST['btn'])){
        $obj_contact_address = new ContactUs();
        $message = $obj_contact_address->save_contact_address_info($_POST);
    }
...
<head>
    ...
    <title>Admin | Contact Address</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!--end -->
                    <div class="well">
                        <h3 class="text-center text-success">Add Car Bikroy Mela Contact Address</h3><br>
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="service_desc" class="col-sm-2 control-label">Email Address</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <button type="submit" name="btn" class="btn btn-success btn-block">Save Contact Address Info</button>
                                </div>
                            </div>
                        </form>
                    </div>
