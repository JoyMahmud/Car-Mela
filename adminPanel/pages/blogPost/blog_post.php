<?php
    ...
    /*blog post information insert in database*/
    ...
    if(isset($_POST['btn'])){
        ...
        $message = $obj_blog_post->save_user_post_info($_POST);
    }
                    ...
                    <div class="well">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="post_details" class="form-control" rows="4" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="checkbox" name="related_topic[]" value="Travel"> Travel
                                </div>
                                <div class="col-sm-1">
                                    <input type="checkbox" name="related_topic[]" value="Journey"> Journey
                            </div>
                                <div class="col-sm-1">
                                    <input type="checkbox" name="related_topic[]" value="Raceing"> Raceing
                                </div>
                                <div class="col-sm-2">
                                    <input type="checkbox" name="related_topic[]" value="Technology"> Technology
                                </div>
                                <div class="col-sm-">
                                    <input type="checkbox" name="related_topic[]" value="Invention"> Invention
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" name="post_Date" placeholder="8 May 2015" class="form-control" required>
                                </div>
                            </div>
